...
def get_train_test_data(clean=True, merge=False):
    ...
    train_sleep = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/train_sleep.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_sleep'])
    test_sleep = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/test_sleep.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_sleep'])
    ...
    train_pa = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/train_pa.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_pa'])
    test_pa = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/test_pa.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_pa'])
    ...
    train_sb = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/train_sb.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_sb'])
    test_sb = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/test_sb.tsv'), sep='\t', usecols=['_id', 'clean_text', 'label_sb'])
...
def get_labeled_data(clean=True):
    ...
    sleep_tweets_df = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/sleep_labeled_dec22.csv'))
    ...
    sb_tweets_df = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/sedentary_labeled_april.csv'))
    ...
    pa_tweets_df = pd.read_csv(os.path.join(os.path.dirname(__file__), '../data/pa_labeled_dec22.csv'))
